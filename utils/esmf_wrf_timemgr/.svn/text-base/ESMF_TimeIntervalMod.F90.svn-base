...
! !PUBLIC MEMBER FUNCTIONS:
      public WRFADDITION_TimeIntervalGet
...
!------------------------------------------------------------------------------
!BOP
! !IROUTINE: WRFADDITION_TimeIntervalGet - Get value in user-specified units

! !INTERFACE:
      subroutine WRFADDITION_TimeIntervalGet(timeinterval, D, d_r8, S, Sn, Sd, &
                                      TimeString, rc )
...
!EOP
      ...
      end subroutine WRFADDITION_TimeIntervalGet
...
! !INTERFACE:
      subroutine ESMF_TimeIntervalGet(timeinterval, yy, mm, D, d_r8, S, S_i8, Sn, Sd, TimeString, rc )
