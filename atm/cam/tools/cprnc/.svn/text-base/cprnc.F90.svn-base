program piocprnc
  ...
  integer :: nvars, numfsk1, ndiffs, numnotfound
...
!
   ...
   call compare_vars(numcases, file, nvars, ndiffs, numfsk1,numnotfound)
...
!
     write(6,806)
      ...
      if(numcases==1) then
         ...
         if (nvars > 0 .and. ndiffs == 0 .and. numfsk1<nvars) then
