...
!-----------------------------------------------------------------------
   ...
   real(r8), public :: dif2 = 0.               !del2 horizontal diffusion coeff.
   real(r8), public :: dif4 = 0.               !del4 horizontal diffusion coeff.
   real(r8) ,public :: divdampn = 0.           ! Number of days to invoke divergence damper
