...
subroutine cam3_ozone_data_register()
   ...
   call pbuf_add('O3', 'physpkg', 1, pver, 1, oz_idx)
...
subroutine cam3_ozone_data_timestep_init(pbuf, phys_state)
!----------------------------------------------------------------------- 
! 
...
!-----------------------------------------------------------------------
   ...
   do lchnk = begchunk, endchunk
      call ozone_data_get_cnst(phys_state(lchnk), pbuf(oz_idx)%fld_ptr(1,:,:,lchnk,1))
   enddo
