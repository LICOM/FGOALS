...
! Atmosphere/clouds - cldprmc [mcica]
      real(kind=r8) :: cldfmc(ngptlw,nlay+1)      ! cloud fraction [mcica]
      real(kind=r8) :: ciwpmc(ngptlw,nlay+1)      ! cloud ice water path [mcica]
      real(kind=r8) :: clwpmc(ngptlw,nlay+1)      ! cloud liquid water path [mcica]
      ...
      real(kind=r8) :: taucmc(ngptlw,nlay+1)      ! cloud optical depth [mcica]
!      real(kind=r8) :: ssacmc(ngptlw,nlay+1)     ! cloud single scattering albedo [mcica]
                                                !   for future expansion 
                                                !   (lw scattering not yet available)
!      real(kind=r8) :: asmcmc(ngptlw,nlay+1)     ! cloud asymmetry parameter [mcica]
                                                !   for future expansion 
                                                !   (lw scattering not yet available)
