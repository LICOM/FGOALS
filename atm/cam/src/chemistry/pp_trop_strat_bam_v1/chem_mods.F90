...
!--------------------------------------------------------------
      ...
      implicit none
      save
      integer, parameter :: hetcnt = 133, & ! number of heterogeneous processes
                            phtcnt = 70, & ! number of photolysis reactions
                            rxntot = 333, & ! number of total reactions
                            gascnt = 263, & ! number of gas phase reactions
                            nabscol = 2, & ! number of absorbing column densities
                            gas_pcnst = 133, & ! number of "gas phase" species
                            nfs = 3, & ! number of "fixed" species
                            relcnt = 0, & ! number of relationship species
                            grpcnt = 0, & ! number of group members
                            nzcnt = 1117, & ! number of non-zero matrix entries
