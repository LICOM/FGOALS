...
!-----------------------------------------------------------------------
	 ...
	 if( hypm(k) >= plb ) then
      ...
      write(iulog,*) ' '
      write(iulog,*) 'aurora_inti: aurora will go down to lev,p = ',lev1,hypm(lev1)
      write(iulog,*) ' '
