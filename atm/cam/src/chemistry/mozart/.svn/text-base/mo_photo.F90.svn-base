...
!-----------------------------------------------------------------
  ...
  subroutine set_ub_col( col_delta, vmr, invariants, ps, pdel, ncol, lchnk )
    !---------------------------------------------------------------
    ...
    has_abs_cols : if( has_o2_col .and. has_o3_col ) then
       if( has_fixed_press ) then
          ...
          !---------------------------------------------------------------
          call p_interp( lchnk, ncol, ps, o2_exo_col, o3_exo_col )
       end if
    else
       o2_exo_col(:) = 0._r8
       o3_exo_col(:) = 0._r8
  ...
  subroutine p_interp( lchnk, ncol, ps, o2_exo_col, o3_exo_col )
    !---------------------------------------------------------------
