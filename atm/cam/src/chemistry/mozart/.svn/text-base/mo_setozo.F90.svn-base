...
!	... local variables
!-----------------------------------------------------------------------------
      real(r8), parameter :: wave_lims(2) = (/ 240.5, 350. /)
      real(r8), parameter :: t_lims(3)    = (/ 226., 263., 298. /)
      real(r8), parameter :: tfac1 = 1./(t_lims(2) - t_lims(1))
      real(r8), parameter :: tfac2 = 1./(t_lims(3) - t_lims(2))
...
!-----------------------------------------------------------------------------
      ...
      cz(1:pver)  = .5*(o3(2:pverp) + o3(1:pver)) * 1.e5 * (z(2:pverp) - z(1:pver))
      to3(pverp)  = o3top
      do k = pver,1,-1
         to3(k) = to3(k+1) + cz(k)
      end do
