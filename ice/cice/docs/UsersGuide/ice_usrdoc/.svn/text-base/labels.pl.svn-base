...
$key = q/table:ice_prescribed_nml/;
...
$key = q/cite_lipshunke04/;
$external_labels{$key} = "$URL/" . q|node40.html|; 
$noresave{$key} = "$nosave";

$key = q/coupled_scripts/;
